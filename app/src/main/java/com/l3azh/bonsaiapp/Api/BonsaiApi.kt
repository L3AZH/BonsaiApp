...
interface BonsaiApi {
    ...
    @DELETE(value = "tree-type/delete-tree-type")
    suspend fun deleteTreeType(
        @Header(value = "Authorization") bearerToken: String,
        @Query(value = "uuidTreeType") uuidTreeType: String
    ): Response<DeleteTreeTypeResponse>
    ...
    @GET(value = "statistic/get-tree-quantity-order-by-day")
    suspend fun getTreeQuantityOrderByDay(
        @Header(value = "Authorization") bearerToken: String,
        @Query(value = "dayNumber") dayNumber: Int
    ): Response<TreeQuantityOrderByDayResponse>

    @GET(value = "statistic/get-total-bill-by-day")
    suspend fun getTotalBillAmountByDay(
        @Header(value = "Authorization") bearerToken: String,
        @Query(value = "dayNumber") dayNumber: Int
    ): Response<TotalBillByDayResponse>
}